    ...
    try {
      ...
      if (IsExit) {
        return errorResponse(
          res,
          ResponseMessage.USER.DUPLICATE_EMAIL,
      ...
      if (IsExitUsername) {
        return errorResponse(
          res,
          ResponseMessage.USER.USERNAME_ALREADY_EXIST,
          STATUSCODE.BadRequest,
        )
      }
  ...
  delete: async (req: Request, res: Response) => {
    try {
      ...
      if (!id) {
        return errorResponse(
          res,
          ResponseMessage.USER.USER_ID_REQUIRED,
          STATUSCODE.BadRequest,
        )
      }
  ...
  resetPassword: async (req: Request, res: Response) => {
    try {
      ...
      if (!isMatched) {
        return errorResponse(
          res,
          ResponseMessage.USER.OLD_PASSWORD_NOT_MATCHED,
          STATUSCODE.BadRequest,
        )
      }
